<#
NAME:     addGroup2LAG.ps1

AUTHOR:   Joe Bruns - Senior Systems Engineer - Thomson Reuters/Rohith Mohandas Technical Lead
...
VERSION HISTORY:
	1.0 	05/24/2018 - Initial release - Joe Bruns
  1.1   06/07/2018 - Changed to be able to run unattended
  1.2 01/31/2019 - Corrected the bug which adds windows support TR to localadmin regardless of divest status. Remove function introduced to remove winddows support tr for FR server and viceversa - Rohith Mohandas
...
Add2LAG $domain2use 'u6045201'
Add2LAG $domain2use $args[0]
